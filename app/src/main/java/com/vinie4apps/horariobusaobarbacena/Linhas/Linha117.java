...
public class Linha117 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SANTA CECILIA");
        ...
        cabeca.setText("Centro x Santa Cecilia");
