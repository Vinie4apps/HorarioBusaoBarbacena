...
public class Linha112 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("BANANAL");
        ...
        cabeca.setText("Centro x Bananal");
        semana.setText("(De segunda a sexta- feira)");
        semanaH.setText("Saída do Jardim do Globo:\n06:30 - 18:10\nSaída do Restaurante Tradição de Minas:\n07:30 - 19:00");
        sabado.setText("Sábado");
        sabadoH.setText("Saída do Jardim do Globo:\n06:30\nSaída do Restaurante Tradição de Minas:\n07:30");
        domingo.setText("");
        domingoH.setText("");
        obs.setText("");
        obsH.setText("");
